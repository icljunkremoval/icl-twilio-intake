...
async function initDb() {
  await pool.query(`
    CREATE TABLE IF NOT EXISTS leads (
      ...
      day_options_snapshot TEXT,
      day_options_snapshot_at TIMESTAMPTZ,
      archived_at TEXT,
      ...
      booking_day TEXT,
      booking_window TEXT,
      booking_start_iso TIMESTAMPTZ,
      booking_end_iso TIMESTAMPTZ,
  ...
  const migrations = [
    ...
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS deposit_paid_amount_cents INTEGER",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS is_test_payment BOOLEAN DEFAULT FALSE",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS quote_total_cents INTEGER",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS base_price_cents INTEGER",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS addon_total_cents INTEGER",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS total_cents INTEGER",
    ...
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS intake_path TEXT",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS needs_manual_review BOOLEAN DEFAULT FALSE",
    ...
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS day_options_snapshot TEXT",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS day_options_snapshot_at TIMESTAMPTZ",
    ...
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS booking_day TEXT",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS booking_window TEXT",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS booking_start_iso TIMESTAMPTZ",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS booking_end_iso TIMESTAMPTZ",
